...
const Envelope: React.FC<EnvelopeProps> = ({ onOpen }) => {
  ...
  return (
    ...
    >
      {/* Background Layer (Tetap Gelap agar Cinematic) */}
      ...
      >
        <div className="space-y-12">
          {/* Header Title (Tetap Putih karena Background Luar Gelap) */}
          ...
          {/* Elegant Guest Card - PERBAIKAN DI SINI */}
          <div className="relative group">
            ...
            <div className="relative frosted-glass p-10 md:p-16 rounded-[2.8rem] shadow-2xl border border-white/20 dark:border-white/10 space-y-8 overflow-hidden">
              ...
              <div className="space-y-3 relative z-10">
                {/* Text: Accent Dark (untuk Light Mode) / Accent (untuk Dark Mode) */}
              ...
              <div className="py-2 relative z-10">
                {/* Nama Tamu: Hitam (Light Mode) / Putih (Dark Mode) */}
              ...
              <div className="pt-2 relative z-10">
                {/* Deskripsi: Abu Gelap (Light Mode) / Abu Terang (Dark Mode) */}
